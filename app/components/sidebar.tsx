      ...
      <div>
        ...
        <div className="px-6">
          <input
            ...
            className="w-full px-4 py-2 rounded-lg border border-gray-300 text-sm focus:outline-blue-400"
          />
        </div>

        <nav className="mt-6 px-4 flex flex-col gap-3">
          {navItems.map((item) => {
      ...
      <div className="w-full px-4 pb-6">
        <div className="flex items-center gap-3 bg-white px-3 py-3 rounded-xl shadow-sm border border-gray-200">
          <div className="flex-1 text-sm">
            ...
            <p className="text-gray-500 text-xs">tester@bu.edu</p>
          </div>
